...
$(document).ready(function(){
	...
	$("#btnLogin").click(function(){
		...
		if(flag==0){
			$.ajax({
				type: "post",
				url: "/ShopDienTuOnline/loginAdminServlet",
				data: {
					email : email,
					pass : pass
				},
				success : function(response){
					if(response=="success"){
						window.location.href = "http://localhost:8080/ShopDienTuOnline/Admin/HomeAdmin.jsp";
					}
		...
		$("#alert-emailSuccess").html('')
		 ...
		 $('#sendForgot').click(function(){
				...
				if(flag==0){
						 $.ajax({
							type : "post",
							url : "/ShopDienTuOnline/forgotPasswordServlet",
							data : {
								email : email,
...
<section style="margin-top:30px;">
		...
		<form id="form-login" > 
		<h3 style="text-align:center;margin-bottom:20px; margin-top:20px">QUẢN LÍ AELECTRONIC</h3>

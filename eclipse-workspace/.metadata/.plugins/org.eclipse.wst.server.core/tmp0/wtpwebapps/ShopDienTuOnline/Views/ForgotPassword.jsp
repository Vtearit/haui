                    		...
                    		var email = "<%=request.getParameter("email")%>"
											$.ajax({
														...
														success : function(
																response) {
															if (response == "success") {
																window.location.href = "http://localhost:8888/ShopDienTuOnline/Views/Home.jsp";
...
<section style="margin-top:30px;">
		...
		<div class="form-group">
			...
			<div class="form-group">
				...
				<button class="btn-login" type="button" data-button="changePassCustomer" id="savePassword"
					>XÁC NHẬN</button>

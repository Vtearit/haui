	...
	<section>
		...
		<div id="section-content" class=" container">
			<div class="home row">
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img class="d-block w-100"
									src="../img/quangcao/800-300-800x300.png"
									alt="not found">
							</div>

							<div class="carousel-item">
								<img class="d-block w-100"
									src="../img/quangcao/A11-800-300-800x300.png" alt="not found">
							</div>
							<div class="carousel-item">
								<img class="d-block w-100"
									src="../img/quangcao/800-300-800x300-4.png" alt="not found">
							</div>
						</div>
				...
				<div class="slider-right col-lg-4 col-md-12 col-sm-12 col-xs-12">
					...
					<img alt="" src="../img/quangcao/sticky-a51-398-110-398x110.png">
					<img alt="" src="../img/quangcao/2ED22C0B-154B-4108-B279-0793C8E4B76C-398x110.png">
        ...
        <div class="fr-pop-wrap">
            ...
            <ul class="fr-pop-tabs sections-show">
                ...
                <li><a data-frpoptab-num="2" data-frpoptab="#frpoptab-tab-2" href="#">Xiaomi</a></li>
                <li><a data-frpoptab-num="3" data-frpoptab="#frpoptab-tab-3" href="#">Iphone</a></li>
                <li><a data-frpoptab-num="4" data-frpoptab="#frpoptab-tab-4" href="#">Oppo</a></li>
			...
			<p style="margin:0"><%=promotion.getReason() %> ( <%=promotion.getDateStart() %> - <%=promotion.getDateEnd() %> )</p>
             ...
             <div class="fr-pop-tab-cont">
                ...
                <div class=" prod-items fr-pop-tab" id="frpoptab-tab-1">
                 ...
                 <p data-frpoptab-num="2" class="fr-pop-tab-mob" data-frpoptab="#frpoptab-tab-2">Xiaomi</p>
                ...
                <p data-frpoptab-num="3" class="fr-pop-tab-mob" data-frpoptab="#frpoptab-tab-3">Iphone</p>
                ...
                <p data-frpoptab-num="4" class="fr-pop-tab-mob" data-frpoptab="#frpoptab-tab-4">Oppo</p>
        ...
        <div class="fr-pop-wrap">
            ...
            <ul class="fr-pop-tabs sections-show">
                ...
                <li><a data-frpoptab-num="22" data-frpoptab="#frpoptab-tab-22" href="#">Xiaomi</a></li>
                <li><a data-frpoptab-num="23" data-frpoptab="#frpoptab-tab-23" href="#">Iphone</a></li>
                <li><a data-frpoptab-num="24" data-frpoptab="#frpoptab-tab-24" href="#">Oppo</a></li>
            </ul>
      ...
      -->       
             ...
             <div class="fr-pop-tab-cont">
                ...
                <div class=" prod-items fr-pop-tab" id="frpoptab-tab-21">
                 ...
                 <p data-frpoptab-num="22" class="fr-pop-tab-mob" data-frpoptab="#frpoptab-tab-22">Xiaomi</p>
                ...
                <p data-frpoptab-num="23" class="fr-pop-tab-mob" data-frpoptab="#frpoptab-tab-23">Iphone</p>
                ...
                <p data-frpoptab-num="24" class="fr-pop-tab-mob" data-frpoptab="#frpoptab-tab-24">Oppo</p>

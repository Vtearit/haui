...
<head>
<meta charset="UTF-8">
<title>Mua hàng trực tuyến với AElectronic</title>
...
int parseCateID= Integer.parseInt(cateID);
category= categoryDAO.categoryById(parseCateID);
listProduct = productDAO.listProductbyCategory(parseCateID);
...
%>
	<section>
		...
		<div id="section-content" class=" container">
            ...
            <h3 class="component-ttl" style="font-family: serif"><span>sản phẩm <%=category.getName() %></span></h3>

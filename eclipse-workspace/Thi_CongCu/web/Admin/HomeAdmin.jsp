<%@page import="Modal.EmployeeSession"%>
						...
						<div class="dropdown-content">
							<ul>
								...
								<li style="border-top: 0;" class="sub-dropdown"><a
									href="/ShopDienTuOnline/logOutServlet?role=admin"><i class="fas fa-sign-out-alt"></i>Thoát</a></li>
							</ul>
						</div></li>
				</ul>
			</div>

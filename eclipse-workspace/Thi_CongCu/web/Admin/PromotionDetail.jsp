...
<%@page import="DAO.Promotion_detailDAO"%>
<%@page import="Modal.Promotion_detail"%>
				...
				<table class="table table-striped edit-table-view" >
					...
					<tr class="contentPage2 tableViewContent" >
						...
						<button id="btn-edit<%=i%>" class="btn btn-primary btn-edit"
								...
								data-ten="<%=productName %>" >Sửa</button>
						</td>
						<td>
						<button id="btn-delete<%=i%>" class="btn btn-delete"
								...
								data-productId="<%=productID%>" 
								data-promotionId="<%=idPromotion %>" >Xóa</button>
						</td>
					</tr>
 ...
 <script>
  $(function () {	
	...
	showPage = function(page) {
		...
		/*Số nút bấm hiển thị di chuyển trang*/
		var btnPage = Math.ceil(<%=listPromotion_detail.size()%>/pageSize) 
	...
	$(document).ready(function(){
		...
		$("#delete").click(function() {
			...
			$.ajax({
				type : "post",
				url : "/ShopDienTuOnline/promotionDetailServlet",
				data : {
					idProduct : idProduct,
	...
	$("#cmbShowProduct").load("../Admin/cmbCategory.jsp?idCate=2")

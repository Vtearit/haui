...
//		if(sendMail("manhtu295199x@gmail.com", "active", messageForgot())) {
//			System.out.print("ha");
//		}
	...
	public static String messageDelivery() {
		String string = "<!DOCTYPE html>\r\n" + "<html lang=\"en\">\r\n" + "<head>\r\n"
				...
				+ "href=\"http://localhost:8080/ShopDienTuOnline/Views/Home.jsp" + "\">WELCOME TO 500AE</a>\r\n"
				+ "        </div>\r\n" + "        \r\n" + "    </div>\r\n" + "    <div>\r\n" + "    </div>\r\n"
				+ "</div>\r\n" + "</body>\r\n" + "</html>";
		return string;
	}
	...
	public static String messageForgot(String email) {
		String urlString = "http://localhost:8080/ShopDienTuOnline/Admin/ForgotPassword.jsp?email=" + email;
		String string = "<!DOCTYPE html>\r\n" + "<html lang=\"en\">\r\n" + "<head>\r\n"
				+ "    <meta charset=\"UTF-8\">\r\n"
				+ "    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\r\n"
				+ "    <meta http-equiv=\"X-UA-Compatible\" content=\"ie=edge\">\r\n"
				...
				+ "        <hr>\r\n" + "    </div>\r\n" + "    \r\n" + "    <div>\r\n"
				+ "        <p>Chào mừng bạn tới với 500AE. Để thay đổi mật khẩu bạn hãy click vào nút phía dưới.</p>\r\n"
				+ "        <div style=\"text-align: center; margin: 50px 0px\">\r\n"
	...
	public static String messageForgotForCustomer(String email) {
		String urlString = "http://localhost:8080/ShopDienTuOnline/Views/ForgotPassword.jsp?email=" + email;
		String string = "<!DOCTYPE html>\r\n" + "<html lang=\"en\">\r\n" + "<head>\r\n"
				+ "    <meta charset=\"UTF-8\">\r\n"
				+ "    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\r\n"
				+ "    <meta http-equiv=\"X-UA-Compatible\" content=\"ie=edge\">\r\n"
				...
				+ "        <p style=\"font-size: 36px; text-align: center; margin-bottom: 0px\">Thay đổi Mật khẩu</p>\r\n"
				+ "        <hr>\r\n" + "    </div>\r\n" + "    \r\n" + "    <div>\r\n"
				+ "        <p>Chào mừng bạn tới với AElectronic. Để thay đổi mật khẩu bạn hãy click vào nút phía dưới.</p>\r\n"
				+ "        <div style=\"text-align: center; margin: 50px 0px\">\r\n"
				+ "        <a class=\"btn btn-success\" style=\"color: #fff; background-color: #28a745; border-color: #28a745;text-decoration: none;border-radius: 5px; padding: 10px\" href=\""
				+ urlString + "\">Bấm vào đây để thay đổi mật khẩu</a>\r\n" + "        </div>\r\n" + "        \r\n"
				+ "    </div>\r\n" + "    <div>\r\n"
	...
	public static boolean sendMail(String to, String subject, String message) {
		...
		try {
			...
			String user = "manhtu2951999@gmail.com";
			String pass = "thptchuyenbackan";
			String from = "manhtu2951999@gmail.com";

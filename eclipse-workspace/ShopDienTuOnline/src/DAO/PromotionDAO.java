...
public class PromotionDAO {
	public static List<Promotion> listPromotion() throws SQLException {
		...
		while (resultSet.next()) {
			...
			Promotion promotion = new Promotion(resultSet.getInt("id"), afterFormat.format(afterCreatedDate),
					afterFormat.format(afterCreatedDate2), resultSet.getInt("employeeID"),
	...
	public static Promotion PromotionByID(int ID) throws SQLException {
		...
		while (resultSet.next()) {
			...
			promotion = new Promotion(resultSet.getInt("id"), afterFormat.format(afterCreatedDate),
					afterFormat.format(afterCreatedDate2), resultSet.getInt("employeeID"),
					resultSet.getString("reason"));
		}
		return promotion;
	...
	public static Promotion promotionbyCurrentDate() throws SQLException {
		...
		String sqlString = String
				.format("select * from Promotion where dateStart <= '" + date + "' and dateEnd >= '" + date + "'");
	...
	public void insertPromotion(String dateStart, String dateEnd, int idEmployee, String reason) throws SQLException {
		...
		String sql = String.format("insert into dbo.Promotion(dateStart, dateEnd, employeeID,reason) VAlues ('"
				+ dateStart + "','" + dateEnd + "'," + idEmployee + ",N'" + reason + "')");
	...
	public void updatePromotion(String dateStart, String dateEnd, int idEmployee, int id) throws SQLException {
		...
		String sql = String.format("Update dbo.Promotion set dateStart='" + dateStart + "',dateEnd='" + dateEnd
				+ "', employeeID=" + idEmployee + " where id=" + id);

...
public class GoodReceiptDAO {
	public static List<GoodReceipt> listGoodReceipts() throws SQLException {
		...
		while (rSet.next()) {
			...
			GoodReceipt goodReceipt = new GoodReceipt(rSet.getInt("id"), rSet.getInt("employeeID"),
					afterFormat.format(afterCreatedDate), rSet.getInt("total"));
	...
	public int insertGoodReceipt(int id, String time) throws SQLException {
		...
		String sql = String
				.format("select * from GoodReceipt where employeeID=" + id + " and created_date='" + time + "'");
	...
	public static GoodReceipt goodReceiptById(int id) throws SQLException {
		...
		while (rSet.next()) {
			...
			goodReceipt = new GoodReceipt(rSet.getInt("id"), rSet.getInt("employeeID"),
					afterFormat.format(afterCreatedDate), rSet.getInt("total"));
		}
		return goodReceipt;
	}

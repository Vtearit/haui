...
import Modal.GoodReceiptDetail;
...
public class GoodReceiptDetailDAO {
	public static List<GoodReceiptDetail> listGoodReceiptDetailbyID(int id) throws SQLException {
		...
		while (rSet.next()) {
			GoodReceiptDetail goodReceiptDetail = new GoodReceiptDetail(rSet.getInt("id"), rSet.getString("productID"),
					rSet.getInt("goodReceiptID"), rSet.getInt("price"), rSet.getInt("quantity"));
	...
	public int insertGoodReceiptDetail(int id, String productID, int price, int quantity) throws SQLException {
		...
		String sqlString = "INSERT INTO dbo.GoodReceipt_detail(productID,GoodReceiptID,price, quantity) VALUES(N'"

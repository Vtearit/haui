...
public class ProductServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case "newReceipt":
			...
			try {
				int i = productDAO.insertProduct(idProduct1, nameProduct1, priceProductSell1, quantityProduct1,
						imageProduct1, descriptionProduct1, brandProduct1);
				if (i == 1) {
				...
				if (i == 0) {
					...
					if (goodReceiptDetailDAO.insertGoodReceiptDetail(idGoodReceipt, idProduct1, priceProduct1,
							quantityProduct1) == 0) {
		...
		case "addReceipt":
			...
			try {
				...
				if (i == 1) {
					...
					if (goodReceiptDetailDAO.insertGoodReceiptDetail(idGoodReceipt2, idProduct2, priceProduct2,
							quantityProduct2) == 0) {

...
<%@page import="Modal.CustomerSession"%>
	...
	$(document).ready(function() {
		...
		$("#btnSearch").click(function() {
			...
			if(flag==0){
				$.ajax({
						type : "post",
						url : "/ShopDienTuOnline/searchServlet",
						data : {
								textSearch : textSearch
						},
						success : function(response) {
							window.location.href = "http://localhost:8080/ShopDienTuOnline/Views/ListofSearch.jsp"
								}
						});
			}
		})
		...
		$("#btnCustomer").click(function(){
			 ...
			 $("#btnEditCustomer").click(function(){
						...
						if(flag==0){
							...
							$.ajax({
								type: "post",
								url: "/ShopDienTuOnline/editProfileServlet",
								data: {
									id : id,
									nameCustomer : name,
									phoneCustomer : phone,
								...
								success : function(response){
									if(response=="success"){
										window.location.replace("http://localhost:8080/ShopDienTuOnline/Views/Home.jsp");
										}
		...
		$("#btnLogout").click(function(){
			window.location.replace("http://localhost:8080/ShopDienTuOnline/logOutServlet?role=customer");
		})
	...
	<!-- Logo, Shop-menu - start -->
		<div class="header-middle ">
				<div class="header-middle-cont">
					<div class="toplogo">
						<a href="Home.jsp"> <img src="../img/header/logo.png"
				...
				<div class="topcatalog">
					...
					<ul class="topcatalog-list">
						<%
							...
							%>
							<li><a
								href="Brand.jsp?brandID=<%=idBrand%>"><%=nameBrand%></a>
										</li>
										<%
								}
							%>
					...
					<div class=modal-body>
							...
							<div class="tab-content">
								<div id="login" class="tab-pane fade in active">
									...
									<h3>Chào mừng tới 500AE Shop! Đăng nhập ngay</h3>
									<div class=" formLogin">
										<form id="form-login">

...
<body>	 <%
	...
	%>
	<h2 style= "margin-right: 500px;" class="Title-view">Sản Phẩm</h2>
	<button class="btn-addcontent btn btn-primary"> Nhập Sản Phẩm</button>
...
$(document).ready(function() {
	...
	$("#productCategory").load("../Admin/ProductCategory.jsp?idCate=1")
...
function cmbChanged(){
	  var x= $("#cmbCategory").val()
	 	$("#productCategory").load("../Admin/ProductCategory.jsp?idCate="+x)
}
</script>

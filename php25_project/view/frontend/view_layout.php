	...
	<div class="container">
	  <div class="row">
		<div class="col-xs-12 col-sm-12 col-md-3 logo "> <a href="index.php"> <img src="public/frontend/100/047/633/themes/517833/assets/logo221c.jpg?1481775169361" alt="Brick Store" class="img-responsive"> </a> </div>
				...
				<?php 
				 ...
				 ?>
				  <li class="clearfix" id="item-1853038">
					<div class="image"> <a href="index.php?controller=product_detail&id=<?php echo $product["pk_product_id"]; ?>"> <img alt="Sản phẩm 2" src="public/upload/product/<?php echo $product["c_img"]; ?>" title="<?php echo $product["c_name"]; ?>" class="img-responsive"> </a> </div>
					<div class="info">
	  ...
	  <div class="container">
		<div class="row">
		  ...
		  <div class="col-xs-12 col-sm-4">
			...
			<div class="info">
			  <h3>Khuyến mại</h3>
			  <p>Khuyến mại sản phẩm nếu đơn hàng trên 10.000.000đ</p>
			</div>
		  </div>
		  <div class="col-xs-12 col-sm-4">
			...
			<div class="info">
			  <h3>Yên tâm về chất lượng</h3>
			  <p>Hoàn tiền nếu sản phẩm không đảm bảo chất lượng hoặc sản phẩm không đúng miêu tả</p>
			</div>
		  </div>
		</div>
	  </div>
		  ...
		  <div class="row">
			...
			<div class="col-xs-12 col-sm-3">
			  ...
			  <ul class="list-unstyled">
				...
				<li><a href="#">Cam kết và hoàn tiền</a></li>
			...
			<div class="col-xs-12 col-sm-3">
			  ...
			  <ul class="list-unstyled">
				...
				<li><a href="chi-nh-sa-ch-do-i-tra">Chính sách hoàn tiền</a></li>
